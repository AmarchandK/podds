  ...
  void initState() {
    GetAllSongs.audioPlayer.currentIndexStream.listen((index) {
      if (index != null && mounted) {
        ...
        GetAllSongs.audioPlayer.currentIndes = index;
      }
    });
    super.initState();
  }
...
///////////////////////////////////////////////////
                ...
                Row(
                  children: [
                    IconButton(
                      onPressed: () {
                        showSliderDialog(
                            ...
                            min: 0.0,
                            max: 1.0,
                            value: GetSongs.audioPlayer.volume,
                            stream: GetSongs.audioPlayer.volumeStream,
                            onChanged: GetSongs.audioPlayer.setVolume);
                      },
                      icon: GetSongs.audioPlayer.volume == 0.0
                          ? const Icon(
                              Icons.volume_off,
                              color: white,
                            )
                    ...
                    StreamBuilder(
                        stream: GetSongs.audioPlayer.speedStream,
                          ...
                          return IconButton(
                            onPressed: () {
                              showSliderDialog(
                                  ...
                                  min: 0.5,
                                  max: 1.5,
                                  value: GetSongs.audioPlayer.speed,
                                  stream: GetSongs.audioPlayer.speedStream,
                                  onChanged: GetSongs.audioPlayer.setSpeed);
                            },
                    ...
                    IconButton(
                        onPressed: () async {
                          if (GetSongs.audioPlayer.hasPrevious) {
                            await GetSongs.audioPlayer.seekToPrevious();
                    ...
                    StreamBuilder<LoopMode>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        return IconButton(
                          icon: icons[index],
                          onPressed: () {
                            GetSongs.audioPlayer.setLoopMode(cycleModes[
  ...
  Stream<DurationState> get _durationStateStream =>
      Rx.combineLatest2<Duration, Duration?, DurationState>(
          GetSongs.audioPlayer.positionStream,
          GetSongs.audioPlayer.durationStream,
